...
def training_mixed(model, training_dataset, validation_dataset, BATCH_SIZE,
    ...
    rec_history_stage1=[]
    validation_rec_history_stage1=[]
    rec_history_stage2=[]
    validation_rec_history_stage2=[]
    # %%
    ...
    for epoch in range(epochs_stage1):
        ...
        for step_, (x, y) in enumerate(training_dataset):
            ...
            loss_epoch_history.append(metrics['loss'].numpy())
            rec_epoch_history.append(metrics['loss_rec'].numpy())
            if step_ % 1 == 0:
        ...
        rec_history_stage1.append(np.mean(rec_epoch_history))
        validation_rec_history_stage1.append(np.mean(validation_rec_epoch_history))
    # %%
    # ---------------- STAGE 2: MoA + 顶层主干微调 ----------------
    freeze_all(model.backbone)
    # 只开顶层几块（按你命名的层）
    ...
    for epoch in range(epochs_stage2):
        ...
        rec_history_stage2.append(np.mean(rec_epoch_history))
        validation_rec_history_stage2.append(np.mean(validation_rec_epoch_history))
    return {"model":model,"loss_history_stage0":loss_history_stage0,
            "loss_history_stage1":loss_history_stage1,
            "loss_history_stage2":loss_history_stage2,
            "rec_history_stage1":rec_history_stage1,
            "rec_history_stage2":rec_history_stage2,
            "validation_loss_history_stage0":validation_loss_history_stage0,
            "validation_loss_history_stage1":validation_loss_history_stage1,
            "validation_loss_history_stage2":validation_loss_history_stage2,
            "validation_rec_history_stage1":validation_rec_history_stage1,
            "validation_rec_history_stage2":validation_rec_history_stage2}
...
if __name__=='__main__':
    ...
    np.save('loss_history_stage0.npy',model_info['loss_history_stage0'])
    np.save('loss_history_stage1.npy',model_info['loss_history_stage1'])
    np.save('loss_history_stage2.npy',model_info['loss_history_stage2'])
    
    np.save('validation_loss_history_stage0.npy',model_info['validation_loss_history_stage0'])
    np.save('validation_loss_history_stage1.npy',model_info['validation_loss_history_stage1'])
    np.save('validation_loss_history_stage2.npy',model_info['validation_loss_history_stage2'])
    
    np.save('rec_history_stage1.npy',model_info['rec_history_stage1'])
    np.save('rec_history_stage2.npy',model_info['rec_history_stage2'])
    
    np.save('validation_rec_history_stage1.npy',model_info['validation_rec_history_stage1'])
    np.save('validation_rec_history_stage2.npy',model_info['validation_rec_history_stage2'])
