...
if __name__=='__main__':
    ...
    clutter_inference,clutter_prediction=inference_patch(model,test_input_clutter,resize_shape=(256,256),block_size=256,step=4)
    crts_inference,crts_prediction=inference_patch(model,test_input_crts,resize_shape=(256,256),block_size=256,step=4)
    rebar1_inference,rebar1_prediction=inference_patch(model,test_input_rebar1,resize_shape=(256,256),block_size=256,step=4)
    rebar2_inference,rebar2_prediction=inference_patch(model,test_input_rebar2,resize_shape=(256,256),block_size=256,step=4)
    
    pyplot.figure(1)
    pyplot.subplot(221)
    pyplot.imshow(clutter_inference,cmap=cm.gray,extent=(0,2,1,0))
    pyplot.subplot(222)
    pyplot.imshow(crts_inference,cmap=cm.gray,extent=(0,2,1,0))
    pyplot.subplot(223)
    pyplot.imshow(rebar1_inference,cmap=cm.gray,extent=(0,2,1,0))
    pyplot.subplot(224)
    pyplot.imshow(rebar2_inference,cmap=cm.gray,extent=(0,2,1,0))
    
    pyplot.figure(2)
    pyplot.subplot(221)
    pyplot.imshow(clutter_prediction,cmap=cm.gray,extent=(0,2,1,0))
    pyplot.subplot(222)
    pyplot.imshow(crts_prediction,cmap=cm.gray,extent=(0,2,1,0))
    pyplot.subplot(223)
    pyplot.imshow(rebar1_prediction,cmap=cm.gray,extent=(0,2,1,0))
    pyplot.subplot(224)
    pyplot.imshow(rebar2_prediction,cmap=cm.gray,extent=(0,2,1,0))
